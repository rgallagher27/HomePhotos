...
func initServer(cfg config.Config, db *sql.DB) (*http.Server, *scanner.Service, *cache.Service, error) {
	swagger, err := GetSwagger()
	if err != nil {
		return nil, nil, nil, fmt.Errorf("get swagger: %w", err)
	}
	swagger.Servers = nil
